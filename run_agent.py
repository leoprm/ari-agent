...
class AIAgent:
    ...
    def __init__(
        ...
        self.tree_memory_path = tree_memory_path
            ...
            try:
                ...
                if self._memory_enabled or self._user_profile_enabled:
                    ...
                    self._memory_store = MemoryStore(
                        ...
                        memory_dir=str(Path(self.tree_memory_path)) if self.tree_memory_path else None,
                    )
    ...
    def _build_system_prompt_parts(self, system_message: str = None) -> Dict[str, str]:
        ...
        if self._memory_store:
            ...
            if self._lessons_enabled:
                lessons_block = self._memory_store.format_for_system_prompt("lessons")
                if lessons_block:
